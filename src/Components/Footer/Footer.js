  ...
  return (
	...
	<div class="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
		...
		<div class="grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-4">
			<div class="space-y-3">
				<h3 class="tracking-wide uppercase dark:text-gray-300">Product</h3>
				<ul class="space-y-1">
					<li>
			...
			<div class="space-y-3">
				<h3 class="tracking-wide uppercase dark:text-gray-300">Company</h3>
				<ul class="space-y-1">
					<li>
			...
			<div class="space-y-3">
				<h3 class="uppercase dark:text-gray-300">Developers</h3>
				<ul class="space-y-1">
					<li>
	...
	<div class="py-6 text-sm text-center dark:text-gray-300">© 2024 Company Co. All rights reserved.</div>
</footer>
    </div>
  )
}
